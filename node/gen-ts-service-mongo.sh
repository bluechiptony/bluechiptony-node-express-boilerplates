...
npm install --save express cors body-parser jsonwebtoken bcrypt dotenv axios keys-to-camelcase uuid nanoid nanoid nanoid-dictionary redis winston winston-mongodb mongodb mongoose &&
